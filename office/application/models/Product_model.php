...
class product_model extends CI_Model 
{
    ...
    INNER JOIN equipment c  on a.equipment_id = c.equipment_id where a.office_id = '".$member_id."'  ";
	 ...
	 return $query1->result_array();
		...
		public function get_repair1($repair_id){
		...
		(
		  ...
		  INNER JOIN   member b  on a.member_id = b.member_id  
		INNER JOIN equipment c  on a.equipment_id = c.equipment_id where a.repair_id = '".$repair_id."'  ";
		...
		public function submit_edit($repair_status,$repair_id) {
		
	
			$sql ="update repair set repair_status = '".$repair_status."'  where repair_id = '".$repair_id."' ";
			$query1 = $this->db->query($sql);
